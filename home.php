	 ...
	 <?php
      	...
      	/*if(!empty($_POST["subject"]))
        {
       	...
       	?>
       		...
       		<script>
       				location.replace("student_panels.php");
       		</script>
       	<?php
...
<section class=" contactus" style="height: auto;">
	<div class="container headings text-center" >
		<h1 class="text-center font-weight-bold " id="signup">Looking For A Tutor?</h1>
		<p class="text-capitalize pt-1">Join Tuition club , silliguri and connect with more than 25 Lakh students on the platform. Create a strong profile and grow your network.Signup as a Tutor 🙂</p>
	</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-10 offset-lg-2 offset-md-2 offset-1">	
				<form  method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="myForm" >
				    ...
				    <div class="form-group">
				     <select required id="state" class="form-control" name="locality">
				     	 <option value="">--Select State--</options>
				    	...
				    	<div class="form-group">
				     <select required id="city" class="form-control" name="add_1">
				     	 <option value="">--Select City--</options>
					  ...
					  <p class="font-weight-bold" style="text-align: center;">Select Your Board</p>
					</div>
				      <div class="form-group">
					...
					<div class="form-group">
					  ...
					  <p class="font-weight-bold"  style="text-align: center;">Select Your Class(Range)</p>
					</div>
					 <div class="form-group">
				     
				     <select id="board" required class="form-control" name="class" >
				     	 <option value="">--SELECT--</options>
					    <option value="1-5">I-V</option>
					    <option value="6-10">VI-X</option>
					    <option value="11-12">XI-XII</option>
					    <option value="1-12">I-XII</option>
				    ...
				    <div class="form-group">
					  ...
					  <p class="font-weight-bold"  style="text-align: center;">Select Subjects to Study</p>
