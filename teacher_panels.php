...
<!-- *************************contactus o/p start************************* -->
	...
	<div id="tab"  class="container headings text-center" >
...
<div class="container">    
				 ...
				 foreach($subject as $sub)
    {
		    ...
		    if($result3)
		    {
		    	...
		    	while($row3 = $result3->fetch_assoc())
		    	{
		    	 ...
		    	 //echo"</tbody";
			    	...
			    	echo "<h1 class='text-center font-weight-bold' style='color:red;'>Sry...No Student is availabe in your area this time Please revisit after Some days!!<h1>";
		...
		else if($mode=="offline" || $mode=="any")
		{
			foreach($subject as $sub)
    	{
				$query4="select s.sub,r.f_name,r.l_name,r.email,r.mobile from teacher t inner join registration r on r.id=t.id inner join stdsub s on s.id=r.id 
  		...
  		<div class="form-group">
					  ...
					  <p class="font-weight-bold" style="text-align: center;">if your intrested in any of the student,click on intrested and submit please!!</p>
					</div>
